...
public class PayTpTextBuilder {
   ...
   * Minecraft's {@link Component} components and color formatting. Each occurrence of <code>%s</code>
   ...
   * @param textColor       The {@link ChatFormatting} color applied to normal text segments.
   ...
   * </pre>
   *
   * @param text          The original {@link Component} to copy. Its formatting will be preserved.
   * @param hoverText     The {@link Component} to display when the player hovers over the clickable text.
